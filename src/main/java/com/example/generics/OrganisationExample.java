...
public class OrganisationExample {
    public static void main(String[] args) {
        ...
        organisation.addParticipant(new Employee("Arek", "Programista"));
        organisation.addParticipant(new Employee("Kasia", "Programista"));
        organisation.addParticipant(new Contractor("Waldek", "Operator"));
